...
|**domain-mapping**|False|string|Allows mapping of user domain globally - in situations where the Azure Devops domain is different to the Jira domain.|
...
```json
{
  ...
  "domain-mapping": "jiradomain.com=devopsdomain.com",
